...
*/
         ...
         if   (mainForm.description1.value.trim()=="")
	            { 
	            //alert("Please enter your description");
				document.getElementById("description1").style.backgroundColor = "red";
	
	            //document.mainForm.description.focus();   
	            //return false; 
	            }
	
			if (mainForm.valid1.checked== false)
					{
			...
			if (mainForm.title1.value != "")
					...
					if (mainForm.description1.value.trim() != "")
						...
						document.getElementById("description1").style.backgroundColor = "white";
					//	document.getElementById("description").style.backgroundColor = "black";
						//document.getElementById("rectngle").style.backgroundColor = "red";
	}
					if (mainForm.valid1.checked!= false)
